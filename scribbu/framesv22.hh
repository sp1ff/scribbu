...
namespace scribbu {
  ...
  public:
          ...
          const boost::optional<encoding> &src = encoding::ASCII) const
    {
      ...
      return buf.empty() ? string_type() :
        convert_encoding<string>(&(buf[0]), buf.size(), src.get(), dst, rsp);
    }
  ...
  public:
           ...
           const boost::optional<encoding> &src = boost::none) const
    {
      return text_.empty() ? string_type() :
        id3v2_2_frame::as_str<string_type>(&(text_[0]), text_.size(),
                                           unicode(), dst, rsp, src);
    }
  ...
  public:
                ...
                const boost::optional<encoding> &src = boost::none) const
    {
      ...
      return buf.empty() ? string_type() :
        id3v2_2_frame::as_str<string_type>(&(buf[0]), buf.size(),
                                           unicode(), dst, rsp, src);
    }
