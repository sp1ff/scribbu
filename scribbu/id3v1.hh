 ...
 *
  ...
  * of conventions. For instance, according to \ref
  * scribbu_id3v1_refs_2 "[2]", "The specification asks for all fields
  * to be padded with null character (ASCII 0). However, not all
  * applications respect this (an example is WinAmp which pads fields
  * with <space>, ASCII 32)."
  *
